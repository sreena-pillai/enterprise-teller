...
public class Keywords extends TestBase {
	...
	public boolean expectEnabled(WebElement element) {
		return (element.isEnabled());
	}

	public boolean expectDisabled(WebElement element) {
	...
	public boolean elementNotSelected(WebElement element) {
...
//	}
	...
	public List<WebElement> getTableData(WebDriver driver, WebElement tableLoc, String expectedText) throws InterruptedException {
...
//					System.out.println("content>> " + td.getAttribute("textContent").toString());
	...
	public void selectDropdownByVisibleText(WebElement selectDropDown, String visbleText) {
	...
	public void CheckImage(WebElement ImageFile) throws Exception {
	...
	public void getSizeOfImage(WebElement Image) throws Exception {
	...
	public void selectLastOptionInDropDownByIndex(WebElement element) {
	...
	public void selectLastOptionInDropDownByVisibleText(WebElement element) {
